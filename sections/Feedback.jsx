    ...
    <section className={`${styles.paddings} relative z-10 `}>
      ...
      >
        <motion.div
          ...
          className="flex-[.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] relative border-[#6a6a6a]"
        >
        ...
        >
          <img
            src="/planet-09.png"
            alt="planet-09"
            className="w-full lg:h-[610px] object-cover rounded-[40px] min-h-[210px]"
          />
          <motion.div
